...
$allowedGet = ['questionList', 'categoryList', 'stats', 'question', 'questionData', 'accountList'];
$allowedPost = ['addNewQuestion', 'newCategory', 'editQuestion', 'deleteQuestion', 'newAccount', 'logQuestionAnswer'];
$id = $api = $request = '';
